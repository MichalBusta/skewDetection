...
{
public:
	LeftRightHullSkDet(int approximatioMethod = CV_CHAIN_APPROX_TC89_KCOS, double epsilon = 0.01, float precision =0.08, bool isRight = false, bool contourForm=false, int ignoreAngle = IGNORE_ANGLE);
