...
{
public:
	LeftRightHullSkDet(int approximatioMethod = CV_CHAIN_APPROX_TC89_KCOS, double epsilon = 0.01, float precision = 0.1, bool isRight = true, bool contourForm=true, int ignoreAngle = IGNORE_ANGLE);
