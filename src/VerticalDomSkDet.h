...
public:
	VerticalDomSkDet(int approximatioMethod = CV_CHAIN_APPROX_TC89_KCOS, double epsilon = 0.01, int histColWidth = 1, int sigma = 2, int range = 10, int ignoreAngle = 10, int correctAngle = 3);
